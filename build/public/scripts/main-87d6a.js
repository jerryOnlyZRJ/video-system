 ...
 */
function menuEvn() {
    var menuBtn = document.querySelector('.main-header .icon-menu');
 ...
 */
function tabEvns() {
    var tab = new _tab2.default('wrapper');
    tab.active(0);
    tab.listenEves();
}
...
var Tab = function () {
    ...
    _createClass(Tab, [{
        ...
        value: function active(index) {
            ...
            // 更新content
            this.contentItems.forEach(function (contentItem, i) {
                if (index === i) {
